...
?>
    <textarea class="services_text" name="services_1_text" rows="5"><? echo $value ?></textarea>
<?php
}
...
?>
    <img class="services_image services_image_1_js" src="<? echo $value ?>" alt="Выбранный файл">
...
?>
    <input class="services_title" type="text" name="services_2_title" maxlength="100" value="<? echo $value ?>">
<?php
}
...
?>
    <textarea name="services_2_text" class="services_text" rows="5"><? echo $value ?></textarea>
<?php
}
...
?>
    <img class="services_image services_image_2_js" src="<? echo $value ?>" alt="Выбранное изображение">
    <div class="services_select_img_wrapper">
...
?>
    <input class="services_title" type="text" name="services_3_title" value="<? echo $value ?>">
<?php
}
...
?>
    <textarea class="services_title" name="services_3_text" rows="5"><? echo $value ?></textarea>
<?php
}
...
?>
    <img class="services_image services_image_3_js" src="<? echo $value ?>" alt="Выбранное изображение">
    <div class="services_select_img_wrapper">
