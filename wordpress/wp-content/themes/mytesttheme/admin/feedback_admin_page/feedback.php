...
?>
<input class="feedback_title-field" type="text" name="feedback[title]" maxlength="100" value="<?get_feedback_title_name_clb()?>">
<?php
}

function add_feedback_img_clb() {
?>
<img src="<?get_feedback_img()?>" alt="Изображение баннера" class="feedback_img">
...
?>
<input type="text" name="feedback[textbox-descr]" class="feedback_description-textbox" maxlength="100" value="<?get_feedback_description_section_clb()?>">
<?php
}

function add_feedback_description_btn_add_file_clb() {
?>
<input type="text" name="feedback[addfile-descr]" class="feedback_description-add-file" maxlength="100" value="<?get_feedback_description_btn_add_file_clb()?>">
<?php
}

function add_feedback_description_btn_add_foto_clb() {
?>
<input type="text" name="feedback[addfoto-descr]" class="feedback_description-add-foto" maxlength="100" value="<?get_feedback_description_btn_add_foto_clb()?>">
<?php
}

function add_feedback_description_btn_submit_clb () {
?>
<input type="text" name="feedback[btn-submit-descr]" class="feedback_description-btn-submit" maxlength="100" value="<?get_feedback_description_btn_submit_clb()?>">
<?php
}
?>