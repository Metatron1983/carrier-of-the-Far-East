...
function quiz_build() {
	...
	<div class="wrap">
        ...
        <p class="quiz_vote-title quiz_form_block">Проголосовало всего: <span class="quiz_vote-sum"><? get_qize_vote_sum() ?></span></p>
	</div>
	<?php
}
...
?>
<input class="quize_title quiz_form_block" type="text" name="quiz_text_section_title" maxlength="100" value="<?get_quiz_title()?>">
<?php
}

function quiz_text_clb() {
?> 
<textarea class="quiz_text quiz_form_block" name="quiz_text_section_text" rows="3"><?get_quiz_text()?></textarea>
<?php
}

function title_question_1_quiz_clb() {
?>
    <input class="quiz_question-1-title quiz_form_block" type="text" name="quiz_question_1_title" maxlength="100" value="<? get_title_question_1_quiz() ?>">
<?php
}

function text_question_1_quiz_clb() {
?>
    <textarea class="quiz_question-1-text quiz_form_block" name="quiz_question_1_text" rows="3"><? get_text_question_1_quiz() ?> </textarea>
<?php
}

function title_question_2_quiz_clb() {
?>
    <input class="quiz_question-2-title quiz_form_block" type="text" name="quiz_question_2_title" maxlength="100" value="<? get_title_question_2_quiz() ?>">
<?php
}

function text_question_2_quiz_clb() {
?>
    <textarea class="quiz_question-2-text quiz_form_block" name="quiz_question_2_text" rows="3"><? get_text_question_2_quiz() ?> </textarea>
<?php
}

function title_question_3_quiz_clb() {
?>
    <input class="quiz_question-3-title quiz_form_block" type="text" name="quiz_question_3_title" maxlength="100" value="<? get_title_question_3_quiz() ?>">
<?php
}

function text_question_3_quiz_clb() {
?>
    <textarea class="quiz_question-3-text quiz_form_block" name="quiz_question_3_text" rows="3"><? get_text_question_3_quiz() ?> </textarea>
<?php
}
