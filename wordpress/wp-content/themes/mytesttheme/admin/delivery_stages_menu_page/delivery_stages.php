...
?>
    <input class="delivery_stages_title" type="text" name="delivery_stages[main][title]" maxlength="100" value="<?get_delivery_stages_main_title()?>">
<?php
}

function delivery_stages_stage_1_title_clb() {
?>
    <input class="delivery_stages_title" type="text" name="delivery_stages[stage1][title]" maxlength="100" value="<?get_delivery_stages_stage_1_title()?>">
<?php
}

function delivery_stages_stage_1_text_clb() {
?>
    <textarea class="delivery-stages_text" name="delivery_stages[stage1][text]" rows="3" maxlength="1000"><?get_delivery_stages_stage_1_text()?></textarea>
<?php
}

function delivery_stages_stage_2_title_clb() {
?>
    <input class="delivery_stages_title" type="text" name="delivery_stages[stage2][title]" maxlength="100" value="<?get_delivery_stages_stage_2_title()?>">
<?php
}

function delivery_stages_stage_2_text_clb() {
?>
    <textarea class="delivery-stages_text" name="delivery_stages[stage2][text]" rows="3" maxlength="1000"><?get_delivery_stages_stage_2_text()?></textarea>
<?php
}

function delivery_stages_stage_3_title_clb() {
?>
    <input class="delivery_stages_title" type="text" name="delivery_stages[stage3][title]" maxlength="100" value="<?get_delivery_stages_stage_3_title()?>">
<?php
}

function delivery_stages_stage_3_text_clb() {
?>
    <textarea class="delivery-stages_text" name="delivery_stages[stage3][text]" rows="3" maxlength="1000"><?get_delivery_stages_stage_3_text()?></textarea>
<?php
}
?>