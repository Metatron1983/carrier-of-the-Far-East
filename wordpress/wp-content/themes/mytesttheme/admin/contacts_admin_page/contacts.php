...
?>
    <input class="contacts_input" type="text" name="contacts[title]" maxlength="100" value="<? get_contacts_clb_title()?>">
<?php
}

function contacts_clb_phone() {
?>
    <input class="contacts_input" type="text" name="contacts[phone]" maxlength="100" value="<? get_contacts_clb_phone()?>">
<?php
}

function contacts_clb_email() {
?>
    <input class="contacts_input" type="text" name="contacts[email]" maxlength="100" value="<?get_contacts_clb_email()?>">
<?php
}
function contacts_clb_whatsapp() {
?>
    <input class="contacts_input" type="text" name="contacts[whatsapp]" maxlength="100" value="<?get_contacts_clb_whatsapp()?>">
<?php
}
function contacts_clb_skype() {
?>
    <input class="contacts_input" type="text" name="contacts[skype]" maxlength="100" value="<? get_contacts_clb_skype()?>">
<?php
}
function contacts_clb_full_name() {
?>
    <input class="contacts_input" type="text" name="contacts[name]" maxlength="100" value="<? get_contacts_clb_full_name()?>">
<?php
}
function contacts_clb_TIN() {
?>
    <input class="contacts_input" type="text" name="contacts[TIN]" maxlength="100" value="<? get_contacts_clb_TIN()?>">
<?php
}
function contacts_clb_IEC() {
?>
    <input class="contacts_input" type="text" name="contacts[IEC]" maxlength="100" value="<? get_contacts_clb_IEC() ?>">
<?php
}
function contacts_clb_PSRN() {
?>
    <input class="contacts_input" type="text" name="contacts[PSRN]" maxlength="100" value="<? get_contacts_clb_PSRN() ?>">
<?php
}
function contacts_clb_address() {
?>
    <textarea class="contacts_input" name="contacts[address]" rows="3" maxlength="1000"><?get_contacts_clb_address()?></textarea>
<?php
}
?>