...
function manager_main_title_clb() {
    $test = "test";
?>
<input type="text" name="manager[main][title]" class="manager_main-title" maxlength="100" value="<?get_manager_main_title()?>">
<?php
}

function manager_1_img_clb() {
?>
<img class="manager-1_img" src="<? get_manager_1_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[1][name]" class="manager-1_name" maxlength="100" value="<?get_manager_1_name()?>">
<?php
}
function manager_1_position_clb() {
?>
<input type="text" name="manager[1][position]" class="manager-1_position" maxlength="100" value="<?get_manager_1_position()?>">
<?php
}
function manager_1_instagram_clb() {
?>
<input type="text" name="manager[1][instagram]" class="manager-1_instagram" maxlength="100" value="<?get_manager_1_instagram()?>">
<?php
}
function manager_1_VK_clb() {
?>
<input type="text" name="manager[1][VK]" class="manager-1_VK" maxlength="100" value="<?get_manager_1_VK()?>">
<?php
}
function manager_1_linkedin_clb() {
?>
<input type="text" name="manager[1][linkedin]" class="manager-1_lonkedin" maxlength="100" value="<?get_manager_1_linkedin()?>">
<?php
}
...
?>
<img class="manager-2_img" src="<? get_manager_2_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[2][name]" class="manager-2_name" maxlength="100" value="<?get_manager_2_name()?>">
<?php
}
function manager_2_position_clb() {
?>
<input type="text" name="manager[2][position]" class="manager-2_position" maxlength="100" value="<?get_manager_2_position()?>">
<?php
}
function manager_2_instagram_clb() {
?>
<input type="text" name="manager[2][instagram]" class="manager-2_instagram" maxlength="100" value="<?get_manager_2_instagram()?>">
<?php
}
function manager_2_VK_clb() {
?>
<input type="text" name="manager[2][VK]" class="manager-2_VK" maxlength="100" value="<?get_manager_2_VK()?>">
<?php
}
function manager_2_linkedin_clb() {
?>
<input type="text" name="manager[2][linkedin]" class="manager-2_lonkedin" maxlength="100" value="<?get_manager_2_linkedin()?>">
<?php
}
...
?>
<img class="manager-3_img" src="<? get_manager_3_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[3][name]" class="manager-3_name" maxlength="100" value="<?get_manager_3_name()?>">
<?php
}
function manager_3_position_clb() {
?>
<input type="text" name="manager[3][position]" class="manager-3_position" maxlength="100" value="<?get_manager_3_position()?>">
<?php
}
function manager_3_instagram_clb() {
?>
<input type="text" name="manager[3][instagram]" class="manager-3_instagram" maxlength="100" value="<?get_manager_3_instagram()?>">
<?php
}
function manager_3_VK_clb() {
?>
<input type="text" name="manager[3][VK]" class="manager-3_VK" maxlength="100" value="<?get_manager_3_VK()?>">
<?php
}
function manager_3_linkedin_clb() {
?>
<input type="text" name="manager[3][linkedin]" class="manager-3_lonkedin" maxlength="100" value="<?get_manager_3_linkedin()?>">
<?php
}
...
?>
<img class="manager-4_img" src="<? get_manager_4_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[4][name]" class="manager-4_name" maxlength="100" value="<?get_manager_4_name()?>">
<?php
}
function manager_4_position_clb() {
?>
<input type="text" name="manager[4][position]" class="manager-4_position" maxlength="100" value="<?get_manager_4_position()?>">
<?php
}
function manager_4_instagram_clb() {
?>
<input type="text" name="manager[4][instagram]" class="manager-4_instagram" maxlength="100" value="<?get_manager_4_instagram()?>">
<?php
}
function manager_4_VK_clb() {
?>
<input type="text" name="manager[4][VK]" class="manager-4_VK" maxlength="100" value="<?get_manager_4_VK()?>">
<?php
}
function manager_4_linkedin_clb() {
?>
<input type="text" name="manager[4][linkedin]" class="manager-4_lonkedin" maxlength="100" value="<?get_manager_4_linkedin()?>">
<?php
}
...
?>
<img class="manager-5_img" src="<? get_manager_5_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[5][name]" class="manager-5_name" maxlength="100" value="<?get_manager_5_name()?>">
<?php
}
function manager_5_position_clb() {
?>
<input type="text" name="manager[5][position]" class="manager-5_position" maxlength="100" value="<?get_manager_5_position()?>">
<?php
}
function manager_5_instagram_clb() {
?>
<input type="text" name="manager[5][instagram]" class="manager-5_instagram" maxlength="100" value="<?get_manager_5_instagram()?>">
<?php
}
function manager_5_VK_clb() {
?>
<input type="text" name="manager[5][VK]" class="manager-5_VK" maxlength="100" value="<?get_manager_5_VK()?>">
<?php
}
function manager_5_linkedin_clb() {
?>
<input type="text" name="manager[5][linkedin]" class="manager-5_lonkedin" maxlength="100" value="<?get_manager_5_linkedin()?>">
<?php
}
...
?>
<img class="manager-6_img" src="<? get_manager_6_img() ?>" alt="Фото сотрудника">
...
?>
<input type="text" name="manager[6][name]" class="manager-6_name" maxlength="100" value="<?get_manager_6_name()?>">
<?php
}
function manager_6_position_clb() {
?>
<input type="text" name="manager[6][position]" class="manager-6_position" maxlength="100" value="<?get_manager_6_position()?>">
<?php
}
function manager_6_instagram_clb() {
?>
<input type="text" name="manager[6][instagram]" class="manager-6_instagram" maxlength="100" value="<?get_manager_6_instagram()?>">
<?php
}
function manager_6_VK_clb() {
?>
<input type="text" name="manager[6][VK]" class="manager-6_VK" maxlength="100" value="<?get_manager_6_VK()?>">
<?php
}
function manager_6_linkedin_clb() {
?>
<input type="text" name="manager[6][linkedin]" class="manager-6_lonkedin" maxlength="100" value="<?get_manager_6_linkedin()?>">
<?php
}
?>