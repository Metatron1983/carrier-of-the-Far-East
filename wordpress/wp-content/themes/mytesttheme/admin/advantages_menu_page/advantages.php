...
?>
    <input type="text" name="advantages_admin_banner[title]" class="advantages-admin_banner-title" maxlength="100" value="<?get_advantages_admin_banner_title()?>">
<?php
}

function advantages_admin_banner_image_PC_clb() {
?>
    <img class="advantages-admin_banner-image" src="<? get_advantages_admin_banner_image_src() ?>" alt="Текущее изображение">
...
?>
    <img class="advantages-admin_banner-image_tablet" src="<?get_advantages_admin_banner_image_tablet_src()?>" alt="Текущее изображение">
    <div class="advantages-admin_banner-image-wrapper">
...
?>
    <img class="advantages-admin-advantage-1_image" src="<? get_advantages_admin_advantage_1_image() ?>" alt="Текущее изображение">
...
?>
    <input class="advantages-admin-advantage-1_title" type="text" name="advantages-admin-advantage-1[title]" maxlength="100" value="<?get_advantages_admin_advantage_1_title()?>">
<?php
}

function advantages_admin_advantage_1_text_clb() {
?>
    <textarea class="advantages-admin-advantage-1_text" name="advantages-admin-advantage-1[text]" rows="3"><?get_advantages_admin_advantage_1_text()?></textarea>
<?php
}

function advantages_admin_advantage_2_image_clb() {
?>
    <img class="advantages-admin-advantage-2_image" src="<? get_advantages_admin_advantage_2_image() ?>" alt="Текущее изображение">
...
?>
    <input class="advantages-admin-advantage-2_title" type="text" name="advantages-admin-advantage-2[title]" maxlength="100" value="<?get_advantages_admin_advantage_2_title()?>">
<?php
}

function advantages_admin_advantage_2_text_clb() {
?>
    <textarea class="advantages-admin-advantage-2_text" name="advantages-admin-advantage-2[text]" rows="3"><?get_advantages_admin_advantage_2_text()?></textarea>
<?php
}
...
?>
    <img class="advantages-admin-advantage-3_image" src="<? get_advantages_admin_advantage_3_image() ?>" alt="Текущее изображение">
...
?>
    <input class="advantages-admin-advantage-3_title" type="text" name="advantages-admin-advantage-3[title]" maxlength="100" value="<?get_advantages_admin_advantage_3_title()?>">
<?php
}

function advantages_admin_advantage_3_text_clb() {
?>
    <textarea class="advantages-admin-advantage-3_text" name="advantages-admin-advantage-3[text]" rows="3"><?get_advantages_admin_advantage_3_text()?></textarea>
<?php
}

function advantages_admin_advantage_4_image_clb() {
?>
    <img class="advantages-admin-advantage-4_image" src="<? get_advantages_admin_advantage_4_image() ?>" alt="Текущее изображение">
...
?>
    <input class="advantages-admin-advantage-4_title" type="text" name="advantages-admin-advantage-4[title]" maxlength="100" value="<?get_advantages_admin_advantage_4_title()?>">
<?php
}

function advantages_admin_advantage_4_text_clb() {
?>
    <textarea class="advantages-admin-advantage-4_text" name="advantages-admin-advantage-4[text]" rows="3"><?get_advantages_admin_advantage_4_text()?></textarea>
<?php
}
