...
?>
<input class="clients_main-title" type="text" name="clients[main][title]" maxlength="100" value="<?get_clients_title_settings()?>">
<?php
}

function add_clients_cart_1_logo_clb() {
?>
<img class="clients-cart-1_logo-img" src="<?get_clients_cart_1_logo_img_name()?>" alt="Лого">
...
?>
<input class="clients-cart-1_title" type="text" name="clients[cart1][title]" maxlength="100" value="<?get_clients_cart_1_title()?>">
<?php
}

function clients_cart_1_description_clb() {
?>
<input class="clients-cart-1_description" type="text" name="clients[cart1][description]" maxlength="100" value="<?get_clients_cart_1_description()?>">
<?php
}

function add_clients_cart_2_logo_clb() {
?>
<img class="clients-cart-2_logo-img" src="<?get_clients_cart_2_logo_img_name()?>" alt="Logo2">
...
?>
<input class="clients-cart-2_title" type="text" name="clients[cart2][title]" maxlength="100" value="<?get_clients_cart_2_title()?>">
<?php
}

function clients_cart_2_description_clb() {
?>
<input class="clients-cart-2_description" type="text" name="clients[cart2][description]" maxlength="100" value="<?get_clients_cart_2_description()?>">
<?php
}

function add_clients_cart_3_logo_clb() {
?>
<img class="clients-cart-3_logo-img" src="<?get_clients_cart_3_logo_img_name()?>" alt="Logo3">
...
?>
<input class="clients-cart-3_title" type="text" name="clients[cart3][title]" maxlength="100" value="<?get_clients_cart_3_title()?>">
<?php
}

function clients_cart_3_description_clb() {
?>
<input class="clients-cart-3_description" type="text" name="clients[cart3][description]" maxlength="100" value="<?get_clients_cart_3_description()?>">
<?php
}

function add_clients_cart_4_logo_clb() {
?>
<img class="clients-cart-4_logo-img" src="<?get_clients_cart_4_logo_img_name()?>" alt="Logo4">
...
?>
<input class="clients-cart-4_title" type="text" name="clients[cart4][title]" maxlength="100" value="<?get_clients_cart_4_title()?>">
<?php
}

function clients_cart_4_description_clb() {
?>
<input class="clients-cart-4_description" type="text" name="clients[cart4][description]" maxlength="100" value="<?get_clients_cart_4_description()?>">
<?php
}

function add_clients_cart_5_logo_clb() {
?>
<img class="clients-cart-5_logo-img" src="<?get_clients_cart_5_logo_img_name()?>" alt="Logo5">
...
?>
<input class="clients-cart-5_title" type="text" name="clients[cart5][title]" maxlength="100" value="<?get_clients_cart_5_title()?>">
<?php
}

function clients_cart_5_description_clb() {
?>
<input class="clients-cart-5_description" type="text" name="clients[cart5][description]" maxlength="100" value="<?get_clients_cart_5_description()?>">
<?php
}

function add_clients_cart_6_logo_clb() {
?>
<img class="clients-cart-6_logo-img" src="<?get_clients_cart_6_logo_img_name()?>" alt="Logo6">
...
?>
<input class="clients-cart-6_title" type="text" name="clients[cart6][title]" maxlength="100" value="<?get_clients_cart_6_title()?>">
<?php
}

function clients_cart_6_description_clb() {
?>
<input class="clients-cart-6_description" type="text" name="clients[cart6][description]" maxlength="100" value="<?get_clients_cart_6_description()?>">
<?php
}

function add_clients_cart_7_logo_clb() {
?>
<img class="clients-cart-7_logo-img" src="<?get_clients_cart_7_logo_img_name()?>" alt="Logo7">
...
?>
<input class="clients-cart-7_title" type="text" name="clients[cart7][title]" maxlength="100" value="<?get_clients_cart_7_title()?>">
<?php
}

function clients_cart_7_description_clb() {
?>
<input class="clients-cart-7_description" type="text" name="clients[cart7][description]" maxlength="100" value="<?get_clients_cart_7_description()?>">
<?php
}

function add_clients_cart_8_logo_clb() {
?>
<img class="clients-cart-8_logo-img" src="<?get_clients_cart_8_logo_img_name()?>" alt="Logo8">
...
?>
<input class="clients-cart-8_title" type="text" name="clients[cart8][title]" maxlength="100" value="<?get_clients_cart_8_title()?>">
<?php
}

function clients_cart_8_description_clb() {
?>
<input class="clients-cart-8_description" type="text" name="clients[cart8][description]" maxlength="100" value="<?get_clients_cart_8_description()?>">
<?php
}
?>