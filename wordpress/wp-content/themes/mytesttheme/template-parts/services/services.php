            ...
            <div class="services_inner">
                <div class="services_content-box">
                    ...
                    <div class="services_text-wrapper">
                        <h3 class="services_title"> <? get_services_title(1) ?></h3>
                        <p class="services_text"><? get_services_text(1) ?></p>
                    </div>
                </div>
            </div>
            <div class="services_inner">
                <div class="services_content-box">
                    ...
                    <div class="services_text-wrapper">
                        <h3 class="services_title"><? get_services_title(2) ?></h3>
                        <p class="services_text"><? get_services_text(2) ?></p>
                    </div>
                </div>
            </div>
            <div class="services_inner">
                <div class="services_content-box">
                    ...
                    <div class="services_text-wrapper">
                        <h3 class="services_title"><? get_services_title(3) ?></h3>
                        <p class="services_text"><? get_services_text(3) ?></p>
                    </div>
                </div>
            </div>
        </div>
