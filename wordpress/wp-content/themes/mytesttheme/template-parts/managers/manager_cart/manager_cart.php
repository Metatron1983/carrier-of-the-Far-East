...
<div class="manager_cart">
    <img src="<? $this->show_prop($this->manager_img_src) ?>" alt="Фото сотрудника" class="manager_img">
    <div class="manager_contentbox-wrapper">
        <div class="manager_contentbox">
            <div class="manager_textbox">
                <p class="manager_name"><? $this->show_prop($this->name)?></p>
                <p class="manager_position"><?$this->show_prop($this->position)?></p>
            </div>
            <div class="manager_social">
                <a href="<? $this->show_prop($this->instagram_link) ?>" class="manager_instagram-link"><img src="<? $this->show_prop($this->instagram_img) ?>" alt="instagram-logo" class="manager_instagram-img"></a>
                <a href="<? $this->show_prop($this->VK_link) ?>" class="manager_VK-link"><img src="<? $this->show_prop($this->VK_img) ?>" alt="VK-logo" class="manager_VK-img"></a>
                <a href="<? $this->show_prop($this->linkedin_link) ?>" class="manager_linkedin-link"><img src="<? $this->show_prop($this->linkedin_img) ?>" alt="linkedin-logo" class="manager_linkedin-img"></a>
            </div>
        </div>
    </div>
</div>
