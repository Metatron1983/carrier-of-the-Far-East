<?php
    ...
    function add_head_style () {
        ...
        wp_register_style('head_style', $theme_uri.'/template-parts/head/head_style.css', false, '0.1');
        wp_register_style('header_style', $theme_uri.'/template-parts/header/header_style.css', false, '0.1');
